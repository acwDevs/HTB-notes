...
#### Use DS query if available


| Command                                                                                                                                                                                          | Result                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------- |
| `dsquery user`                                                                                                                                                                                   | User list                        |
| `dsquery computer`                                                                                                                                                                               | Host List                        |
| `dsquery * "CN=Users,DC=INLANEFREIGHT,DC=LOCAL"`                                                                                                                                                 | Object List                      |
| `dsquery * -filter "(&(objectCategory=person)(objectClass=user)(userAccountControl:1.2.840.113556.1.4.803:=32))" -attr distinguishedName userAccountControl`![[Pasted image 20250103222920.png]] | Users that dont request password |
| `dsquery * -filter "(userAccountControl:1.2.840.113556.1.4.803:=8192)" -limit 5 -attr sAMAccountName`                                                                                            | List of domain controllers       |
...
| `Get-MpComputerStatus`                                                                                                     | Check Windows defender information and status                                                                                                                                                                                                 |
